...
(function (global, factory) {
  ...
  var FAMILY_classNameIC = "classNameic";
  var FAMILY_SHARP = "sharp";
  var FAMILIES = [FAMILY_classNameIC, FAMILY_SHARP];

  function familyProxy(obj) {
    // Defaults to the classNameic family if family is not available
    return new Proxy(obj, {
      get: function get(target, prop) {
        return prop in target ? target[prop] : target[FAMILY_classNameIC];
      },
    });
  }
  var PREFIX_TO_STYLE = familyProxy(
    ((_familyProxy = {}),
    _defineProperty(_familyProxy, FAMILY_classNameIC, {
      fa: "solid",
      fas: "solid",
      "fa-solid": "solid",
      far: "regular",
  ...
  var STYLE_TO_PREFIX = familyProxy(
    ((_familyProxy2 = {}),
    _defineProperty(_familyProxy2, FAMILY_classNameIC, {
      solid: "fas",
      regular: "far",
      light: "fal",
      thin: "fat",
  ...
  var PREFIX_TO_LONG_STYLE = familyProxy(
    ((_familyProxy3 = {}),
    _defineProperty(_familyProxy3, FAMILY_classNameIC, {
      fab: "fa-brands",
      fad: "fa-duotone",
      fak: "fa-kit",
      fal: "fa-light",
  ...
  var LONG_STYLE_TO_PREFIX = familyProxy(
    ((_familyProxy4 = {}),
    _defineProperty(_familyProxy4, FAMILY_classNameIC, {
      "fa-brands": "fab",
      "fa-duotone": "fad",
      "fa-kit": "fak",
      "fa-light": "fal",
  ...
  var FONT_WEIGHT_TO_PREFIX = familyProxy(
    ((_familyProxy5 = {}),
    _defineProperty(_familyProxy5, FAMILY_classNameIC, {
      900: "fas",
      400: "far",
      normal: "far",
      300: "fal",
  ...
  Object.keys(STYLE_TO_PREFIX[FAMILY_classNameIC]).map(
    prefixes.add.bind(prefixes)
  );
  Object.keys(STYLE_TO_PREFIX[FAMILY_SHARP]).map(prefixes.add.bind(prefixes));
  var RESERVED_classNameES = []
    .concat(FAMILIES, _toConsumableArray(prefixes), [
      ...
      "stack",
      "ul",
      DUOTONE_classNameES.GROUP,
      DUOTONE_classNameES.SWAP_OPACITY,
      DUOTONE_classNameES.PRIMARY,
      DUOTONE_classNameES.SECONDARY,
    ])
    .concat(
